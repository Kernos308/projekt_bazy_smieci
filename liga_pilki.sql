...
--
-- Host: 127.0.0.1
-- Generation Time: Sty 18, 2024 at 12:05 PM
...
CREATE TRIGGER `usuniecie_danych_statystyki_trigger` BEFORE DELETE ON `statystyki` FOR EACH ROW BEGIN
    -- Przeniesienie rekordu do archiwum
    INSERT INTO archiwum_statystyki (`statystyki_id`, `mecz_id`, `druzyna_id`, `posiadanie_pilki`, `podania`, `strzaly_celne`, `strzaly_niecelne`, `rzuty_rozne`,
	`rzuty_karne`, `faule`, `spalone`)
    VALUES (OLD.statystyki_id, OLD.mecz_id, OLD.druzyna_id, OLD.posiadanie_pilki, OLD.podania, OLD.strzaly_celne, OLD.strzaly_niecelne, OLD.rzuty_rozne,
    OLD.rzuty_karne, OLD.faule, OLD.spalone);
END
$$
DELIMITER ;
...
(662, 'Olisabebe', '2024-01-02', 'Niemcy', 'GK', 3);
...
DELIMITER ;
DELIMITER $$
CREATE TRIGGER `logowanie_update_zawodnik` AFTER INSERT ON `zawodnik` FOR EACH ROW BEGIN
    INSERT INTO logi (user, polecenie)
...
--
-- AUTO_INCREMENT for table `archiwum_druzyna`
--
ALTER TABLE `archiwum_druzyna`
  MODIFY `druzyna_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `archiwum_mecz`
--
ALTER TABLE `archiwum_mecz`
  MODIFY `mecz_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `archiwum_statystyki`
--
ALTER TABLE `archiwum_statystyki`
  MODIFY `statystyki_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `archiwum_zawodnik`
--
ALTER TABLE `archiwum_zawodnik`
  MODIFY `zawodnik_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `mecz`
  MODIFY `mecz_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `zawodnik`
  MODIFY `zawodnik_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=663;
...
--
-- Constraints for table `archiwum_mecz`
--
ALTER TABLE `archiwum_mecz`
...
--
-- Constraints for table `archiwum_statystyki`
--
ALTER TABLE `archiwum_statystyki`
...
--
-- Constraints for table `archiwum_zawodnik`
--
ALTER TABLE `archiwum_zawodnik`
